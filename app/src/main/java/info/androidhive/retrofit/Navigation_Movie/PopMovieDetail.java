...
public class PopMovieDetail extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private static final String TAG = PopMovieDetail.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getQueryInformation();
        image_info_moviedetail = findViewById(R.id.image_info_moviepop);
        text_info_moviedetail = findViewById(R.id.text_info_moviepop);
        title_info_moviedetail = findViewById(R.id.title_info_movipop);


        getQueryTrailer();
        YouTubePlayerView youTubePlayerView = findViewById(R.id.youtube_pop_movie);
