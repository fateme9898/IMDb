...
public class UpMovieDetail extends YouTubeBaseActivity implements  YouTubePlayer.OnInitializedListener {
    ...
    private static final String TAG = UpMovieDetail.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_up_movie_detail);
        ...
        getQueryInformation();
        image_info_moviedetail = findViewById(R.id.image_info_movieup);
        text_info_moviedetail = findViewById(R.id.text_info_movieup);
        title_info_moviedetail = findViewById(R.id.title_info_moviup);



        getQueryTrailer();
        YouTubePlayerView youTubePlayerView = findViewById(R.id.youtube_up_movie);
