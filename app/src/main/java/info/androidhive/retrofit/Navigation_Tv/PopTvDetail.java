...
public class PopTvDetail extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener{
    ...
    private static final String TAG = PopTvDetail.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pop_tv_detail);
        ...
        getQueryInformation();
        image_info_moviedetail = findViewById(R.id.image_info_tvpop);
        text_info_moviedetail = findViewById(R.id.text_info_tvpop);
        title_info_moviedetail = findViewById(R.id.tvpop);

        getQueryTrailer();
        YouTubePlayerView youTubePlayerView = findViewById(R.id.youtube_pop_tv);
