 ...
 * {@link NavigationTvPop.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NavigationTvPop#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NavigationTvPop extends Fragment {
     ...
     * @return A new instance of fragment NavigationTvPop.
     */
    // TODO: Rename and change types and number of parameters
    public static NavigationTvPop newInstance(String param1, String param2) {
        NavigationTvPop fragment = new NavigationTvPop();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_navigation_tv_pop, container, false);
        ...
        final RecyclerView recyclerView = view.findViewById(R.id.recyclerview_poptv);
        ...
        call.enqueue(new Callback<TvResponse>() {
            ...
            public void onResponse(Call <TvResponse> call, Response<TvResponse> response) {
                ...
                List<Tv> poptv=response.body().getResults();
                PopTvAdapter adapter=new PopTvAdapter(poptv , R.layout.list_item_tv_pop,getContext() );
